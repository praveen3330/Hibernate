	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			if (transaction != null) {
				...
				cardPayment.setammount(8000.5f);
				...
				chequePayment.setammount(4500.56f);
				
				chequePayment.setChequeNo(546345L);
				chequePayment.setChequeType("self");
				chequePayment.setExpiryDate(LocalDate.of(2023, 04, 27));
			...
			if (flag) {
				...
				System.out.println("Object no saved to the database...");
			}
